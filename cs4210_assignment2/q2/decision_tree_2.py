...
dataSets = ['q2/contact_lens_training_1.csv', 'q2/contact_lens_training_2.csv', 'q2/contact_lens_training_3.csv']

#Reading the test data in a csv file using pandas
dbTest = []
df_test = pd.read_csv('q2/contact_lens_test.csv')
